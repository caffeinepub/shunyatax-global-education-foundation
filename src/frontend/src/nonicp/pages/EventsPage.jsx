...
import { getAllEvents } from '../data/staticDataClient';
...
export default function EventsPage() {
  ...
  const sortedEvents = [...filteredEvents].sort((a, b) => Number(b.date) - Number(a.date));
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {sortedEvents.map((event, index) => {
                ...
                return (
                  ...
                  >
                    <CardHeader>
                      <div className={`mb-2 inline-block px-3 py-1.5 rounded-full text-xs font-semibold ${
                        isUpcoming 
