...
export default function ContactPage() {
  ...
  const { useSubmitContactForm } = useQueries();
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              {/* Map Link */}
              <Card className="animate-on-scroll overflow-hidden border-border/50 bg-card/80 backdrop-blur-sm" style={{ animationDelay: '200ms' }}>
                <a 
                  ...
                  className="block"
                >
                  <div className="aspect-video bg-gradient-to-br from-primary/8 via-accent/8 to-primary/8 relative overflow-hidden group cursor-pointer">
                    ...
                    <div className="flex h-full items-center justify-center">
                      <div className="text-center transition-transform duration-300 group-hover:scale-110">
                        <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-primary/15 to-accent/15 transition-all duration-300 group-hover:from-primary/25 group-hover:to-accent/25">
