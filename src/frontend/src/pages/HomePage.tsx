...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Enhanced parallax effect for hero images with scroll
    const handleScroll = () => {
      ...
      if (imagesRef.current) {
        ...
        images.forEach((img, index) => {
          ...
          element.style.transform = `translateY(${currentScrollY * speed}px) scale(${1 + currentScrollY * 0.0001})`;
        });
      }

      // Parallax effect for impact images
      if (impactRef.current) {
        ...
        images.forEach((img, index) => {
          ...
          (img as HTMLElement).style.transform = `translateY(${offset * speed}px)`;
        });
      }
    };

    // Cursor movement parallax effect for hero images
    const handleMouseMove = (e: MouseEvent) => {
      if (imagesRef.current) {
        ...
        // Apply subtle cursor-based parallax to images
        const images = imagesRef.current.querySelectorAll('.parallax-image');
        images.forEach((img, index) => {
          const depth = (index + 1) * 10; // Depth multiplier for each layer
          const moveX = x * depth;
          const moveY = y * depth;
          ...
          (img as HTMLElement).style.transform = `translateY(${currentScrollY * speed}px) translateX(${moveX}px) scale(${1 + currentScrollY * 0.0001}) rotateY(${x * 3}deg) rotateX(${-y * 3}deg)`;
        });
      }
    };
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section with Enhanced Dynamic Animated Background and Featured Images */}
      <section
        ref={heroRef}
        className="relative flex min-h-screen items-center justify-center overflow-hidden pt-20"
      >
        {/* Enhanced animated gradient background with luminosity variations */}
        ...
        {/* Floating orbs for depth with enhanced glow */}
        ...
        <div className="container relative z-10 mx-auto px-4 py-20">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            {/* Hero Content - Center Aligned with Enhanced Typography */}
            ...
            {/* Hero Images Grid with Enhanced Animations, Glow Effects, and Interactive Parallax */}
            <div ref={imagesRef} className="relative h-[600px] lg:h-[700px]" style={{ perspective: '1200px' }}>
              {/* Main large image with enhanced glow and interactive zoom */}
              <div 
              ...
              >
                {/* Multi-layered pulsating glow aura with enhanced effects */}
                ...
                {/* Enhanced brightness overlay with scroll-based zoom */}
              ...
              {/* Secondary image - bottom left with enhanced hover parallax */}
              <div 
              ...
              >
                {/* Layered glow effects with enhanced intensity */}
              ...
              {/* Tertiary image - bottom right with enhanced hover parallax */}
              <div 
              ...
              {/* Enhanced decorative elements with pulsating glow */}
      ...
      {/* Stats Section with Enhanced Staggered Animation */}
      ...
      {/* Impact Images Section with Enhanced Parallax and Interactive Scroll Effects */}
