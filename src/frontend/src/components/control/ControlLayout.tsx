...
const navigation = [
  ...
  { name: 'Programs', href: '/control-panel/programs', icon: BookOpen },
  { name: 'Events', href: '/control-panel/events', icon: Calendar },
  { name: 'Gallery', href: '/control-panel/gallery', icon: ImageIcon },
  { name: 'Team', href: '/control-panel/team', icon: Users },
  { name: 'Impact Stories', href: '/control-panel/impact', icon: Heart },
  { name: 'Site Settings', href: '/control-panel/site-settings', icon: Settings },
];
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-20 items-center justify-between px-6 border-b border-primary-foreground/10">
            <Link to="/control-panel" className="flex items-center gap-3">
              <img
